...
class DetailViewModel {
    ...
    fun changeText(car:CarsModel, binding: ActivityDetailBinding){
        ...
        (car.pricePerDay.toString()+"€/"+context?.getString(R.string.day)).also { binding.carPrice.text = it }
        ...
        car.rating?.average?.let {
            getStars(binding.carStar1,binding.carStar2,binding.carStar3,binding.carStar4,binding.carStar5,
                it
            )
        }
        car.owner?.rating?.average?.let {
            getStars(binding.ownerStar1,binding.ownerStar2,binding.ownerStar3,binding.ownerStar4,binding.ownerStar5,
                it
            )
        }
